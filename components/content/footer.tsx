...
import { PlayCircle, SkipBack, SkipForward, Shuffle, Volume2 } from 'react-feather';
     ...
     <footer className="w-full p-4 md:p-6 bg-gray-400 text-gray-100 fixed bottom-0 border-t border-gray-300 h-16 md:h-24 flex justify-between items-center z-50">
      ...
      <div className="flex md:justify-center flex-1">
        <div className="flex items-center">
          <div className="transform hover:scale-105 hover:text-green-spotify transition duration-200 mx-2 md:mx-3">
          ...
          {socials.map(({ id, icon: Icon, url }) => (
            <div key={id} className="transform hover:scale-105 hover:text-green-spotify transition duration-200 mx-2 md:mx-3">
