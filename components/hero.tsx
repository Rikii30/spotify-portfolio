...
import profilePicture from '../public/assets/riki.jpg';
    ...
    <div className="h-96 md:bg-gradient-to-b from-gray-200 to-gray-400 flex flex-col justify-end p-4 md:p-7 text-white">
      <div className="flex flex-col md:flex-row items-center md:items-end">
        ...
        <div className="md:ml-6 mt-3 md:mt-0 text-center md:text-left">
          ...
          <div className="text-4xl sm:text-5xl md:text-3xl lg:text-6xl xl:text-7xl font-extrabold">@rikshitharavikumar</div>
        </div>
      </div>
    </div>
  );
      ...
      >
        <div className="z-10">
          <div className="flex items-center">
            ...
            <span className="uppercase text-xs md:text-sm md:font-semibold">Masters Student</span>
          </div>
