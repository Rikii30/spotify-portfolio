...
const Home: NextPage = () => {
  ...
  return (
    <Main pageBackground="purpleGradient" pageTitle="Rikshitha Ravikumar">
      <AnimatePresence>{isNavbarDisplayed && <Navbar text="Rikshitha Ravikumar" sendMailIcon />}</AnimatePresence>
            ...
            <div className="relative col-span-5 xl:col-span-4 h-96 p-5 pb-7 md:p-10 rounded-md flex flex-col justify-end overflow-hidden bg-gradient-to-t from-gray-300 to-gray-200">
              <div className="z-10">
                <div className="text-xl md:text-3xl">
                  Helloooo! My name is <span className="font-extrabold text-2xl md:text-4xl">Rikshitha Ravikumar.</span>
                </div>
